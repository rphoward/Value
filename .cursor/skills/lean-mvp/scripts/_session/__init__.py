...
from .coaching import coaching_for_atom, flatten_kb_value, load_atom_coaching
...
from .runtime import (
    ...
    module_outcome,
    prepare_gate_accept,
    records_include_gate_pass,
    session_has_gate_pass,
    synthesize_gate_pass_decision,
