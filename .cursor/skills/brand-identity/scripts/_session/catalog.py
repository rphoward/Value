...
from .constants import MODULE_BRIEF_LABEL, MODULE_ORDER, SLUG_RE, WORKPRODUCT_ROOT
...
def default_workproduct_root() -> Path:
    """Prefer <repo>/<workproduct_root from skill-config> over cwd-relative paths."""
    repo = resolve_repo_root()
    if repo is not None:
        return repo / WORKPRODUCT_ROOT
    return Path(WORKPRODUCT_ROOT)
