# States and flows — Value Design

Critical paths only. Weight Empty and Error — sampling dies there.
...
- (hypothesis) Pain relievers (mostly hypothesis from lived use): (1) Mid-session grill shifts frame — more of one's own mind than pure coding-with-AI; calmer; exercises a part of the brain that atrophies under regular AI use. (2) Memory/reference files give endurance — work isn't wasted; an enduring record (like a finished vibe-coding artifact) that future decisions can stand on. (3) Decision tool steers toward choosing to be valuable to others, not only autonomous self — reduces pains of dead showcase / lack of interaction, eroded self-confidence and competence, diminished personal worth, and feeling less worthy of relationships with others. (4) Peer Discord paste voice so-whats feature notes into daily relief (who + freeze + what you get) — reduces the extreme pain of lack of marketing skills when saying why someone else would care in showcase, without feature laundry or false pitch enthusiasm.
