...
A Cursor skill pack for taking a vibecoded idea through clarity, business model, lean MVP scope, and an honest marketable claim.

Five skills install together:
...
Product-Spine routes; siblings grill. On claim, Product-Spine opens saved notes — you should not hunt folders.
